...
class FeedNormalizerTest < Test::Unit::TestCase
  ...
  def test_times_are_reparsed
    ...
    assert_equal "Sat Sep 09 14:57:06 UTC 2006", feed.last_updated.utc.to_s(:foo)
    assert_equal "Sat Sep 09 12:45:35 UTC 2006", feed.entries.first.date_published.utc.to_s(:foo)
  end
